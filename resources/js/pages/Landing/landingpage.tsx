...
const SIGNATURE = [
  { no: '01', name: 'Es Kopi Senja', note: 'gula aren · susu segar · espresso', price: '28K',
    img: 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=800&q=80' },
  { no: '02', name: 'V60 Gayo', note: 'manual brew · cokelat · jeruk', price: '38K',
    img: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800&q=80' },
  { no: '03', name: 'Butter Croissant', note: 'dipanggang setiap pagi', price: '25K',
    img: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=800&q=80' },
];

const MENU = [
  { id: 1, name: 'Es Kopi Senja',   desc: 'Espresso · susu segar · gula aren', price: 28000, cat: 'Kopi',        tag: 'Best Seller', img: 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=600&q=80' },
  { id: 2, name: 'Flat White',      desc: 'Double ristretto · microfoam',      price: 32000, cat: 'Kopi',        img: 'https://images.unsplash.com/photo-1512568400610-62da28bc8a13?w=600&q=80' },
  { id: 3, name: 'V60 Single Origin', desc: 'Gayo · cokelat · jeruk',          price: 38000, cat: 'Manual Brew', tag: 'Baru',        img: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600&q=80' },
  { id: 4, name: 'Cold Brew 12 Jam', desc: 'Diseduh dingin · smooth',          price: 30000, cat: 'Kopi',        img: 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=600&q=80' },
  { id: 5, name: 'Matcha Latte',     desc: 'Uji matcha · oat milk',            price: 35000, cat: 'Non-Kopi',    img: 'https://images.unsplash.com/photo-1536010305525-f7aa0834e2c7?w=600&q=80' },
  { id: 6, name: 'Butter Croissant', desc: 'Dipanggang setiap pagi',           price: 25000, cat: 'Pastry',      img: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=600&q=80' },
];
      ...
      <div className="relative min-h-screen bg-cream font-sans text-ink selection:bg-terracotta selection:text-cream">
        ...
        <header
          className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 ${
            scrolled
              ? 'bg-cream/80 backdrop-blur-md border-b border-ink/10 py-3 rounded-full p-30'
              : 'bg-transparent py-6'
          }`}
        >
              ...
              <div className="col-span-12 lg:col-span-7">
                ...
                <Reveal delay={0.1}>
                  <h1 className="font-display text-[clamp(2.75rem,8vw,7rem)] font-normal leading-[0.95] tracking-[-0.02em]">
                    ...
                    <br />
                    dengan{' '}
                    <em className="italic text-terracotta">kesabaran</em>,
                    <br />
                    disajikan dengan{' '}
                ...
                <Reveal delay={0.2}>
                  <p className="mt-8 max-w-md text-[15px] leading-relaxed text-ink/65">
                    Kami memilih biji dari petani kecil di Gayo, Toraja, dan Kintamani.
                    Setiap cangkir adalah hasil dari proses yang tidak pernah kami buru-buru.
                  </p>
                </Reveal>
              ...
              <div className="mt-24 grid grid-cols-2 gap-6 border-t border-ink/10 pt-8 md:grid-cols-4 md:gap-12">
                {[
                  ...
                  <div key={l}>
                    ...
                    <p className="mt-2 text-xs uppercase tracking-widest text-ink/50">{l}</p>
                  </div>
                ))}
              </div>
            </Reveal>
          ...
          <div className="flex animate-[marquee_40s_linear_infinite] gap-12 whitespace-nowrap will-change-transform">
            {[0, 1].map((k) => (
              <div key={k} className="flex shrink-0 items-center gap-12">
                {['SINGLE ORIGIN', 'MANUAL BREW', 'HOMEMADE PASTRY', 'SLOW BAR', 'NO RUSH', 'SEASONAL BLEND'].map(
                  (t) => (
                    <span key={t} className="flex items-center gap-12 font-display text-3xl text-ink/30 md:text-4xl">
                      {t}
              ...
              <div className="mb-16 flex flex-wrap items-end justify-between gap-6">
                <div>
                  ...
                  <h2 className="font-display text-5xl leading-[1.05] md:text-6xl">
                    Tiga hal yang <em className="italic">paling</em>
                    <br />
                    sering dipesan.
                  </h2>
                </div>
                <p className="max-w-xs text-sm leading-relaxed text-ink/60">
                  Kalau ini kunjungan pertama, mulai dari salah satu dari tiga ini.
                </p>
              </div>
            </Reveal>
              ...
              {SIGNATURE.map((s, i) => (
                <Reveal key={s.no} delay={i * 0.08}>
                  <div
                    ...
                    onMouseEnter={() => setHoveredSig(s.no)}
                    onMouseLeave={() => setHoveredSig(null)}
                  >
                    <span className="w-12 font-display text-lg text-ink/30">{s.no}</span>
                    ...
                    <span className="font-display text-2xl text-terracotta">{s.price}</span>
        ...
        {/* ================= MENU / ORDER ================= */}
        <section id="menu" className="bg-ink py-32 text-cream md:py-40">
          <div className="mx-auto max-w-[1400px] px-6 md:px-10">
            <Reveal>
              <div className="mb-12 flex flex-wrap items-end justify-between gap-8">
                <div>
                  ...
                  <h2 className="font-display text-5xl leading-[1.05] md:text-6xl">
                    Pilih, tambah, <em className="italic">nikmati</em>.
                  </h2>
                </div>
                ...
                <Reveal key={item.id} delay={i * 0.06}>
                  <article className="group">
                    <div className="relative aspect-[4/5] overflow-hidden rounded-sm bg-ink/40">
                      ...
                      {item.tag && (
                        <span className="absolute left-4 top-4 rounded-full bg-cream px-3 py-1 text-[10px] font-semibold uppercase tracking-widest text-ink">
                          {item.tag}
                        </span>
                      )}
                      ...
                      <button
                        onClick={() => add(item)}
                        className="absolute bottom-4 right-4 grid h-12 w-12 translate-y-2 place-items-center rounded-full bg-cream text-ink opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100 hover:bg-terracotta hover:text-cream"
                    ...
                    <div className="mt-5 flex items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-cream/55">{item.desc}</p>
                      </div>
                      <span className="whitespace-nowrap font-display text-lg text-terracotta">
                        {rupiah(item.price)}
                      </span>
                    </div>
                  </article>
          ...
          <div className="mx-auto max-w-[1400px] px-6 md:px-10">
            <div className="grid grid-cols-12 gap-10">
              <Reveal className="col-span-12 lg:col-span-5">
                ...
                <h2 className="font-display text-5xl leading-[1.05] md:text-6xl">
                  Mampir, duduk,<br />
                  <em className="italic">tinggal lebih lama</em>.
                </h2>

                <div className="mt-10 space-y-6 text-sm">
                  <div>
                    <p className="text-xs uppercase tracking-widest text-ink/40">Alamat</p>
                    <p className="mt-1 leading-relaxed">
                      Jl. Braga No. 88, Sumur Bandung<br />
                      Kota Bandung, Jawa Barat 40111
                    </p>
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-widest text-ink/40">Jam Buka</p>
                    <p className="mt-1">Senin — Kamis · 08:00 – 22:00</p>
                    <p>Jumat — Minggu · 08:00 – 24:00</p>
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-widest text-ink/40">Kontak</p>
                    <p className="mt-1">+62 812 3456 7890 · hello@senja.id</p>
                  </div>
                </div>
              </Reveal>
              ...
              <Reveal delay={0.15} className="col-span-12 lg:col-span-7">
                <div className="relative aspect-[5/4] overflow-hidden rounded-sm">
                  ...
                  <div className="absolute bottom-6 left-6 rounded-sm bg-cream/95 px-5 py-3 backdrop-blur">
                    <p className="text-xs uppercase tracking-widest text-ink/50">Senja Coffee</p>
                    <p className="mt-1 font-display text-lg">Braga, Bandung</p>
                  </div>
                </div>
              </Reveal>
            </div>
          ...
          <div className="mx-auto max-w-[1400px] px-6 py-16 md:px-10">
            <div className="grid grid-cols-12 gap-8">
              ...
              <div className="col-span-6 md:col-span-2">
                <p className="mb-4 text-xs uppercase tracking-widest text-ink/40">Jelajahi</p>
                <ul className="space-y-2 text-sm">
                  <li><a href="#menu" className="hover:text-terracotta">Menu</a></li>
                  <li><a href="#cerita" className="hover:text-terracotta">Cerita</a></li>
                  <li><a href="#lokasi" className="hover:text-terracotta">Lokasi</a></li>
                </ul>
              </div>
              <div className="col-span-6 md:col-span-2">
                <p className="mb-4 text-xs uppercase tracking-widest text-ink/40">Sosial</p>
                <ul className="space-y-2 text-sm">
                  <li><a href="#" className="hover:text-terracotta">Instagram</a></li>
                  <li><a href="#" className="hover:text-terracotta">TikTok</a></li>
                  <li><a href="#" className="hover:text-terracotta">WhatsApp</a></li>
                </ul>
              </div>
              <div className="col-span-12 md:col-span-2">
                <p className="mb-4 text-xs uppercase tracking-widest text-ink/40">Newsletter</p>
            ...
            <div className="mt-16 flex flex-wrap items-center justify-between gap-4 border-t border-ink/10 pt-6 text-xs text-ink/40">
              <p>© {new Date().getFullYear()} Senja Coffee. Semua hak cipta dilindungi.</p>
        ...
        {count > 0 && !cartOpen && (
          <button
            ...
            style={{ animation: 'pop .4s cubic-bezier(.16,1,.3,1)' }}
          >
            <span className="grid h-6 w-6 place-items-center rounded-full bg-cream text-xs font-semibold text-ink">
              {count}
            </span>
            <span className="text-sm font-medium">{rupiah(total)}</span>
            <span className="text-xs uppercase tracking-widest">Lihat</span>
          </button>
        )}
        ...
        >
          ...
          >
            <div className="flex items-center justify-between border-b border-ink/10 px-6 py-5">
              <div>
                <p className="text-xs uppercase tracking-widest text-ink/40">Pesanan kamu</p>
                <p className="mt-1 font-display text-2xl">{count} item</p>
              </div>
              <button
                onClick={() => setCartOpen(false)}
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4">
              {cart.length === 0 ? (
                <p className="mt-10 text-center text-sm text-ink/50">Keranjang masih kosong.</p>
              ) : (
                <ul className="divide-y divide-ink/10">
                  {cart.map((x) => (
                    <li key={x.id} className="flex items-center gap-4 py-4">
                      <img src={x.img} alt={x.name} className="h-16 w-16 rounded-sm object-cover" />
                      <div className="flex-1">
                        <p className="font-display text-lg leading-tight">{x.name}</p>
                        <p className="text-xs text-ink/50">{rupiah(x.price)} × {x.qty}</p>
                      </div>
                      <button
                        onClick={() => remove(x.id)}
            ...
            <div className="border-t border-ink/10 px-6 py-6">
              <div className="mb-4 flex items-center justify-between">
                ...
                <span className="font-display text-3xl">{rupiah(total)}</span>
              </div>
              <button
              ...
              <p className="mt-3 text-center text-[11px] text-ink/40">
                Bayar di kasir atau transfer — kamu akan diarahkan ke halaman konfirmasi.
              </p>
            </div>
          </aside>
        </div>
